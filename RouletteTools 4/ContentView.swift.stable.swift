...
//
                            RouletteWheel()
                                ...
                                .rotationEffect(
//                                    .degrees(9.756756756756757 * wheelMultiplier)
...
//                                .foregroundColor(Color(red: 50/255, green: 50/255, blue: 0/255)) // set to default roulette colors unless heatmap values active)
...
//                                            .zIndex(0)
//                                            .overlay(Circle().frame(width: button.touchArea, height: button.touchArea).foregroundColor(Color.yellow.opacity(0.3)).zIndex()
                                        }
...
//                                                .overlay(Text(String(rouletteNumBetSize[button.storedValue])).font(.system(size: 13)).offset(x:-18, y: 19))
    ...
    //                                        .background(Color.clear)
                                     ...
                                     // attempt to expand touch region of smaller squares
                                    
                                    
                                    
                                    
//                                    .onLongPressGesture(minimumDuration: 0.5, maximumDistance: 5) {subtractChip(storedValue: button.storedValue)} Apply this line to the .overlay above. It doesn't seem to work right on the whole button
